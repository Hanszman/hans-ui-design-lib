...
describe('HansSelectOption', () => {
  ...
  it('Should filter options when autocomplete is enabled', async () => {
    ...
    render(
      <HansSelectOption label="Search" options={options} enableAutocomplete />,
    );
  ...
  it('Should open dropdown upwards when there is not enough space below', async () => {
    ...
    const rectSpy = vi
      ...
      .mockImplementation(function (this: HTMLElement) {
        ...
        if (
          this.classList.contains('hans-popup-panel') ||
          this.classList.contains('hans-select-option-list')
        ) {
          return {
            x: 0,
            y: 0,
  ...
  it('Should not open dropdown when disabled', async () => {
    render(<HansSelectOption label="Disabled" options={options} disabled />);
  ...
  it('Should ignore open trigger on wrapper when disabled', () => {
    render(<HansSelectOption label="Disabled" options={options} disabled />);
    const wrapper = document.querySelector('.hans-select-option-field');
